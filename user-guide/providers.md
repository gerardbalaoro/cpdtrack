...
![](../assets/providers-view.png)

## Verification

The **verfied badge** ![](../assets/fa-check-circle-b%20%281%29.png) lets users know that an account or page is authentic. This also grants additional features to page administrators, such as the ability to customize their provider's handle.
